$(document).ready(function(){
	...
	function getValue(input){
		...
		//set it back to default if true
			...
			//we don't want to have two operators in a row or a dot after an operator
    } else if ((operators1.includes(input) || operators2.includes(input) ) && operators1.includes(inputs[inputs.length-1])){
